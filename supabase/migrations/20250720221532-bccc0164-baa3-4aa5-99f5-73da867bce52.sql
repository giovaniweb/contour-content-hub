-- ===================================
-- MIGRAÇÃO DE HIGIENIZAÇÃO DE SEGURANÇA - CORREÇÃO
-- APENAS PARA TABELAS (REMOVENDO VIEWS)
-- ===================================

-- 1. ATIVAR RLS APENAS EM TABELAS REAIS
-- =====================================
...
-- OBS: database_documentation é uma VIEW, não uma tabela, então não pode ter RLS

-- 2. CONFIGURAR SEARCH_PATH EM TODAS AS FUNÇÕES
-- =============================================
