-- FASE 5: Corrigir problemas restantes de segurança (versão corrigida)
...
-- Usuários podem criar suas próprias fotos
...
-- Usuários podem editar suas próprias fotos
...
-- Permitir visualização de todos os vídeos para usuários autenticados
-- (assumindo que vídeos são conteúdo educativo público)
