-- Fix critical user registration issues
-- Update trigger function to save ALL metadata fields from user signup
...
BEGIN
  ...
  INSERT INTO public.perfis (
    ...
    CASE 
      WHEN NEW.raw_user_meta_data->>'equipamentos' IS NOT NULL 
