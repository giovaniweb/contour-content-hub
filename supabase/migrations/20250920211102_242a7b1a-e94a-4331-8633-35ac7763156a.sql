...
DROP POLICY IF EXISTS "Admins can insert profiles" ON public.perfis;
DROP POLICY IF EXISTS "Admins can update profiles" ON public.perfis;
DROP POLICY IF EXISTS "Admins can delete profiles" ON public.perfis;
