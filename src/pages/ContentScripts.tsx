...
const ContentScripts: React.FC = () => {
  ...
  return <div className="p-6 space-y-8">
      ...
      delay: 0.1
        ...
        <Button onClick={() => navigate(ROUTES.CONTENT.SCRIPTS.GENERATOR)} className="aurora-button bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 px-8 py-4 text-lg font-semibold aurora-glow" size="lg">
        ...
        <Card className="aurora-card border-2 relative overflow-hidden">
          ...
          <CardContent className="relative z-10">
            <div className="space-y-4">
              {scripts.map((script, index) => <motion.div key={script.id} initial={{
              opacity: 0,
              x: -20
            }} animate={{
              opacity: 1,
