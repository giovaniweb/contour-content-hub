      ...
      <div className="container mx-auto px-6 space-y-8">
        ...
        {isLoading ? <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          length: 8
            ...
            {filteredVideos.map(video => <div key={video.id} className="bg-slate-800/50 border-2 border-slate-700/50 hover:border-cyan-400/50 rounded-2xl transition-all duration-300 hover:shadow-lg hover:shadow-cyan-400/10">
                <div className="p-4">
