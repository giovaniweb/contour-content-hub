...
const AdminSystemIntelligence: React.FC = () => {
  ...
  return (
    <ContentLayout 
      title="Inteligência Artificial do Sistema" 
      subtitle="Configure e monitore os modelos de IA integrados ao Fluida"
    >
      <div className="space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <GlassContainer className="bg-white/80 border-0 shadow-sm">
