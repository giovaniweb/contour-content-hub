            ...
            <form onSubmit={handleSubmit}>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link to={ROUTES.FORGOT_PASSWORD} className="text-sm text-reelline-primary hover:underline">
                      Esqueceu a senha?
                    </Link>
                  </div>
                  <Input 
              ...
              <CardFooter className="flex flex-col space-y-4">
                ...
                <p className="text-center text-sm text-muted-foreground">
                  Não tem uma conta?{" "}
                  <Link to={ROUTES.REGISTER} className="text-reelline-primary hover:underline">
                    Criar conta
                  </Link>
                </p>
              </CardFooter>
