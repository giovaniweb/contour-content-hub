...
const ScriptGeneratorPage: React.FC = () => {
  ...
  return <div className="min-h-screen aurora-dark-bg relative overflow-hidden">
      {/* Aurora Particles Background */}
      <div className="aurora-particles">
        {Array.from({
        length: 20
      }, (_, i) => <div key={i} className="aurora-particle" style={{
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="mb-8">
          <Button variant="ghost" onClick={handleGoBack} className="mb-6 aurora-glass border-purple-300/30 hover:border-purple-400/50 aurora-body text-white/90 hover:text-white">
            <ArrowLeft className="h-4 w-4 mr-2" />
            Voltar
          </Button>
          
          <div className="text-center">
            <h1 className="aurora-text-gradient text-4xl font-bold mb-4 flex items-center justify-center gap-3 relative z-10 text-slate-50">
        ...
        {approvedScript ? <SmartResultDisplay generationResult={{
      ...
      }} onGenerateImage={handleGenerateImage} onGenerateVoice={handleGenerateVoice} onNewScript={handleNewScript} onApplyDisney={handleApplyDisneyMagic} onApproveScript={() => {}} isDisneyApplied={approvedScript.mentor === 'Fluida Encantadora'} isApproved={true} isProcessing={false} /> : <Tabs defaultValue="fluidaroteirista" className="max-w-4xl mx-auto">
            <TabsList className="grid w-full grid-cols-2 aurora-glass border-purple-300/30">
              <TabsTrigger value="fluidaroteirista" className="flex items-center gap-2 aurora-body data-[state=active]:aurora-accent data-[state=active]:bg-purple-500/20 text-white/80 data-[state=active]:text-white">
                <Wand2 className="h-4 w-4" />
                FLUIDAROTEIRISTA
              </TabsTrigger>
              <TabsTrigger value="test" className="flex items-center gap-2 aurora-body data-[state=active]:aurora-accent data-[state=active]:bg-purple-500/20 text-white/80 data-[state=active]:text-white">
