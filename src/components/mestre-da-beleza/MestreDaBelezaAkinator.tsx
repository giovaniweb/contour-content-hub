            ...
            >
              ...
              <div className="flex flex-wrap gap-4 justify-center w-full">
                {akinator.ranking.slice(0, 3).map((eq, idx) => (
                  <div key={eq.id} className="p-4 bg-gradient-to-br from-purple-900/50 to-pink-900/30 rounded-xl flex flex-col items-center w-52 border border-purple-400/30 shadow">
